...
public class TC54FundTransferInvalidInputTwiceConfirmationMessage extends wrappers.ProjectWrappers{

	public TC54FundTransferInvalidInputTwiceConfirmationMessage() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC54 -Funds Transfer - Invalid Input Twice while entering Confirmation Message";
		TestDescription="TC54- Funds Transfer - Invalid Input Twice while entering Confirmation Message";
		browserName="chrome";
