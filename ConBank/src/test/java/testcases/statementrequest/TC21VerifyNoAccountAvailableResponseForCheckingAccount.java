...
public class TC21VerifyNoAccountAvailableResponseForCheckingAccount extends wrappers.ProjectWrappers{

	public TC21VerifyNoAccountAvailableResponseForCheckingAccount() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC21 - To verify that user is able to view No Account available bot response when given Checking account is not available";
