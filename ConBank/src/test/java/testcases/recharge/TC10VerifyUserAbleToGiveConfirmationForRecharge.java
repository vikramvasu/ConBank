...
public class TC10VerifyUserAbleToGiveConfirmationForRecharge extends wrappers.ProjectWrappers{

	public TC10VerifyUserAbleToGiveConfirmationForRecharge() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC10 - To Verify that user is able to give confirmation for recharge";
		TestDescription="To Verify that user is able to give confirmation for recharge";
		browserName="Chrome";
	...
	@Test(priority=1)
	public void giveConfirmationForRecharge() throws Exception
	{
