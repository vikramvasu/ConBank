...
public class TC13VerifyUserAbleToCancelConfirmationForRecharge extends wrappers.ProjectWrappers{

	public TC13VerifyUserAbleToCancelConfirmationForRecharge() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC13 - To Verify that user is able to Cancel the Transaction by selecting NO in Recharge Confirmation";
		TestDescription="To Verify that user is able to Cancel the Transaction by selecting NO in Recharge Confirmation";
		browserName="Chrome";
	...
	@Test(priority=1)
	public void cancelConfirmationForRecharge() throws Exception
	{
		...
		.EnterText("100")
		.cancelRechargeText()
		.verifyCancelText("Your request has been cancelled.")
