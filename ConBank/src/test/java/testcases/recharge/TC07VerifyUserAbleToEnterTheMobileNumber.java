...
public class TC07VerifyUserAbleToEnterTheMobileNumber extends wrappers.ProjectWrappers{

	public TC07VerifyUserAbleToEnterTheMobileNumber() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC07 - To Verify that user is able to enter the Mobile Number";
		TestDescription="To Verify that user is able to enter the Mobile Number";
		browserName="Chrome";
	...
	@Test(priority=1)
	public void EnterMobieNumberForRecharge() throws Exception
	{
