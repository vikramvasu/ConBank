...
public class TC50ValidateIfUserSelectsYesForConfirmOperator extends wrappers.ProjectWrappers{

	public TC50ValidateIfUserSelectsYesForConfirmOperator() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC50 - Validate if user selects YES for Confirm Operator";
		TestDescription="Validate if user selects YES for Confirm Operator";
		browserName="Chrome";
	...
	@Test(priority=1)
	public void selectYESForConfirmOperator() throws Exception
	{
