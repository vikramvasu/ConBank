...
public class TC08VerifyUserAbleToConfirmTheOperatorDisplayed extends wrappers.ProjectWrappers{

	public TC08VerifyUserAbleToConfirmTheOperatorDisplayed() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC08 - To Verify that user is able to confirm the operator displayed";
		TestDescription="To Verify that user is able to confirm the operator displayed";
		browserName="Chrome";
	...
	@Test(priority=1)
	public void ConfirmOperatorForRecharge() throws Exception
	{
