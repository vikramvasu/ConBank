...
public class TC54VerifyIfUserEnterInvalidAmount_NegativeBalOrZERO extends wrappers.ProjectWrappers{

	public TC54VerifyIfUserEnterInvalidAmount_NegativeBalOrZERO() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC54 - Verify if User enters invalid amount - Negative amount or ZERO";
		TestDescription="Verify if User enters invalid amount - Negative amount or ZERO";
		browserName="Chrome";
