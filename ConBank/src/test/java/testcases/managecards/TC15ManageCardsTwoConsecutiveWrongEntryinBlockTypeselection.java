...
public class TC15ManageCardsTwoConsecutiveWrongEntryinBlockTypeselection extends wrappers.ProjectWrappers{

	public TC15ManageCardsTwoConsecutiveWrongEntryinBlockTypeselection() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC15 - To verify that user able to view Two Consecutive Invalid Entry Message when user wrong input twice while selecting Block/Unblock Type Slot";
		TestDescription="TC15 - To verify that user able to view Two Consecutive Invalid Entry Message when user wrong input twice while selecting Block/Unblock Type Slot";
		browserName="chrome";
