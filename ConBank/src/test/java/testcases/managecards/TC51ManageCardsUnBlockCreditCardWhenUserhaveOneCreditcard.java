...
public class TC51ManageCardsUnBlockCreditCardWhenUserhaveOneCreditcard extends wrappers.ProjectWrappers{

	public TC51ManageCardsUnBlockCreditCardWhenUserhaveOneCreditcard() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC51 - To verify that user able to unblock the debit card based on supported Intent - unblock Credit card";
		TestDescription="TC51 - To verify that user able to unblock the debit card based on supported Intent - unblock Credit card";
		browserName="chrome";
