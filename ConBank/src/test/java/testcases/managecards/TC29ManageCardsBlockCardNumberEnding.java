...
public class TC29ManageCardsBlockCardNumberEnding extends wrappers.ProjectWrappers{

	public TC29ManageCardsBlockCardNumberEnding() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC29 - To verify that user able to block the card based on supported Intent - Block card by card number ending with"; 	    
		TestDescription="TC29 - To verify that user able to block the card based on supported Intent - Block card by card number ending with";
		browserName="chrome";
