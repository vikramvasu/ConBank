...
public class JIRA_TC13_ValidateIfUserSelectsWrongOperator extends wrappers.ProjectWrappers{

	public JIRA_TC13_ValidateIfUserSelectsWrongOperator() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC13 - Validate if user selects wrong Operator";
