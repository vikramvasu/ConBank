...
public class JIRA_TC12_ValidateIfUserSelectsNoForConfirmOperator extends wrappers.ProjectWrappers{

	public JIRA_TC12_ValidateIfUserSelectsNoForConfirmOperator() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC12 - Validate if user selects NO for Confirm Operator";
