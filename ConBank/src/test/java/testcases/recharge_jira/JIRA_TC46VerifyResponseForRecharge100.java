...
public class JIRA_TC46VerifyResponseForRecharge100 extends wrappers.ProjectWrappers{

	public JIRA_TC46VerifyResponseForRecharge100() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC46 - To Verify 'Recharge 100'";
	...
	@Test(priority=1)
	public void verifyRecharge100() throws Exception
	{
		...
		.confirmOperatorText(); // Bot is asking to enter Amount again
	}
