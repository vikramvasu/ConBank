...
public class JIRA_TC11_ValidateIfUserSelectsYesForConfirmOperator extends wrappers.ProjectWrappers{

	public JIRA_TC11_ValidateIfUserSelectsYesForConfirmOperator() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC11 - Validate if user selects YES for Confirm Operator";
