...
public class JIRA_TC14_ValidateIfUserSelectsOtherOperator extends wrappers.ProjectWrappers{

	public JIRA_TC14_ValidateIfUserSelectsOtherOperator() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC14 - Validate once user selects any other Operator then User should ask user to enter amount";
