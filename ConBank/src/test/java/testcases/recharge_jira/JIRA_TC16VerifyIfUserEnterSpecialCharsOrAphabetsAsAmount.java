...
public class JIRA_TC16VerifyIfUserEnterSpecialCharsOrAphabetsAsAmount extends wrappers.ProjectWrappers{

	public JIRA_TC16VerifyIfUserEnterSpecialCharsOrAphabetsAsAmount() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="JIRA - TC16 - Verify if User enters invalid amount - Special Chars or Alphabets";
