...
public class TC52PayCreditCardPayClickOnOtherAmount extends wrappers.ProjectWrappers{

	public TC52PayCreditCardPayClickOnOtherAmount() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC52 - To Verify that the bot should allow the user to click on Other Amount"  ; 
		TestDescription="TC52 - To Verify that the bot should allow the user to click on Other Amount";
		browserName="chrome";
