...
public class TC09PayCreditCardEnterOTP extends wrappers.ProjectWrappers{

	public TC09PayCreditCardEnterOTP() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC09 - To Verify that the user able to enter the OTP";
		TestDescription="TC09 - To Verify that the user able to enter the OTP";
		browserName="chrome";
	...
	@Test
	public void PayCreditCardEnterOTP() throws Exception
	{
