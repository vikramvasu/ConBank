...
public class TC54PayCreditCardPayEnteredtheWrongAmount extends wrappers.ProjectWrappers{

	public TC54PayCreditCardPayEnteredtheWrongAmount() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC54 - To Verify that the user should be allowed to view the proper validation message when the user enters wrong amount values"  ; 
		TestDescription="TC54 - To Verify that the user should be allowed to view the proper validation message when the user enters wrong amount values";
		browserName="chrome";
