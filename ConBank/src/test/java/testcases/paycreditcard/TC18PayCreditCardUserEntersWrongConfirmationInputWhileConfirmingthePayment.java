...
public class TC18PayCreditCardUserEntersWrongConfirmationInputWhileConfirmingthePayment extends wrappers.ProjectWrappers{

	public TC18PayCreditCardUserEntersWrongConfirmationInputWhileConfirmingthePayment() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC18 - To Verify that the user should be allowed to view the proper validation message when the user enters wrong confirmation inputs while confirming the payment";
		TestDescription="TC18 - To Verify that the user should be allowed to view the proper validation message when the user enters wrong confirmation inputs while confirming the payment";
		browserName="chrome";
