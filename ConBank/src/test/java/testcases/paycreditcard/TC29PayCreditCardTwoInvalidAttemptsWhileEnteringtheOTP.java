...
public class TC29PayCreditCardTwoInvalidAttemptsWhileEnteringtheOTP extends wrappers.ProjectWrappers{

	public TC29PayCreditCardTwoInvalidAttemptsWhileEnteringtheOTP() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC29 - To Verify that the bot should cancel the conversation when user enters wrong inputs for two invalid attempts while entering the OTP";
		TestDescription="TC29 - To Verify that the bot should cancel the conversation when user enters wrong inputs for two invalid attempts while entering the OTP";
		browserName="chrome";
