...
public class TC21PSDBEnrollattheBranchInstruction extends wrappers.ProjectWrappers{

	public TC21PSDBEnrollattheBranchInstruction() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC21 - To verify if user click on Enroll at the Branch- Instruction ";
