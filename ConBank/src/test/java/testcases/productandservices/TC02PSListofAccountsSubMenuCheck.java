...
public class TC02PSListofAccountsSubMenuCheck extends wrappers.ProjectWrappers{

	public TC02PSListofAccountsSubMenuCheck() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC02 - To Verify if user enter or tap on Accounts - Sub menu  ";
	...
	@Test
	public void ListofAccountSubMenuCheck() throws Exception
	{
