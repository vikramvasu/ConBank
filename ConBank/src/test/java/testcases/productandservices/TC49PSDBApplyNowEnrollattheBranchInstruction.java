...
public class TC49PSDBApplyNowEnrollattheBranchInstruction extends wrappers.ProjectWrappers{

	public TC49PSDBApplyNowEnrollattheBranchInstruction() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC49 - To verify if user click on Enroll at the Branch- Instruction ";
