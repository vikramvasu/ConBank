...
public class TC26ChequeBookRequestbyAccountNumberwhichislinkedtoOtherAccounttype extends wrappers.ProjectWrappers{

	public TC26ChequeBookRequestbyAccountNumberwhichislinkedtoOtherAccounttype() throws IOException {
		super();
	...
	@BeforeClass
	public void setData() {
		TestCaseName="TC26 - ChequeBook Request by Account Number ending with - Correct Account Number ending With";
